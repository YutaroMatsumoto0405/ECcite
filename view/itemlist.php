    ...
    <body>
        ...
        <header>
            ...
            <ul>
                ...
                <li class="register"><a href="#">買い物かご</a></li>
                <li class="login"><a href="#">購入履歴</a></li>
                <li class="login"><a href="#">お気に入り</a></li>
                <li class="cart"><a href="#">ログアウト</a></li>
                </ul>
        </header>
        </div>
        <div class="bgcolor">
            ...
            <article>
                ...
                <?php if ($_SERVER['REQUEST_METHOD'] === 'POST'){ ?>
                    <?php if(isset($_POST['sql_type']) === TRUE) { ?>
                            ...
                            <div class="item">
                                <p><img class="item" src=" <?php print $img_dir . $value['img']; ?>"></p>
